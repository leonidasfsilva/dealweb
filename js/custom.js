...
/* Atribui ao evento keypress do input data de nascimento a função para formatar a data (dd/mm/yyyy) */
...
if (inputDataNascimento != null && inputDataNascimento.addEventListener) {
    inputDataNascimento.addEventListener("keypress", function () {
        mascaraTexto(this, '##/##/####')
    });
} else if (inputDataNascimento != null && inputDataNascimento.attachEvent) {
    inputDataNascimento.attachEvent("onkeypress", function () {
        mascaraTexto(this, '##/##/####')
    });
}
...
if (inputTelefone != null && inputTelefone.addEventListener) {
    inputTelefone.addEventListener("keypress", function () {
        mascaraTexto(this, '## ####-####')
    });
} else if (inputTelefone != null && inputTelefone.attachEvent) {
    inputTelefone.attachEvent("onkeypress", function () {
        mascaraTexto(this, '## ####-####')
    });
}
...
if (inputCelular != null && inputCelular.addEventListener) {
    inputCelular.addEventListener("keypress", function () {
        mascaraTexto(this, '## #####-####')
    });
} else if (inputCelular != null && inputCelular.attachEvent) {
    inputCelular.attachEvent("onkeypress", function () {
        mascaraTexto(this, '## #####-####')
    });
}

/* Atribui ao evento keypress do input CEP a função para formatar o CEP (00000-000) */
...
if (inputCep != null && inputCep.addEventListener) {
    ...
    inputCep.attachEvent("onkeypress", function () {
        mascaraTexto(this, '#####-###')
    });
}
...
function validaCadastro(evt) {
    ...
    if (nome.value == "") {
        caixa_nome.innerHTML = "Favor informar o nome";
    ...
    if (email.value == "") {
        caixa_email.innerHTML = "Favor informar o e-mail";
    ...
    if (data_nascimento.value == "") {
        caixa_data.innerHTML = "Favor informar a data de nascimento";
    ...
    if (cpf.value == "") {
        caixa_cpf.innerHTML = "Favor informar o número de CPF";
    ...
    if (telefone.value == "") {
        caixa_telefone.innerHTML = "Favor informar o número de telefone";
    ...
    if (celular.value == "") {
        caixa_celular.innerHTML = "Favor informar o número de celular";
    ...
    if (status.value == "") {
        caixa_status.innerHTML = "Favor selecione o status";
